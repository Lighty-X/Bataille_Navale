...
"""
Created on Wed Nov 12 22:27:50 2025
...
class BatailleNavaleApp:
    def __init__(self, root):
        ...
        self.label_joueur = tk.Label(self.frame_joueur, text=self.nom_joueur,
                                     font=("Arial", 14, "bold"), fg=COULEURS["highlight"], bg=COULEURS["fond"])
        ...
        self.label_ia = tk.Label(self.frame_ia, text=self.nom_ia,
                                 font=("Arial", 14, "bold"), fg=COULEURS["highlight"], bg=COULEURS["fond"])
            ...
            for l in range(self.taille):
                for c in range(self.taille):
                    ...
                    canvas.create_rectangle(x0, y0, x1, y1, fill=color,
                                            outline=COULEURS["grille"], width=1.2)
